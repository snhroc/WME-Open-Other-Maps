...
(function() {
    ...
    const updateMessage = "Brampton ON GIS, Halton Red Light Cameras";
...
//            `<div><input type="checkbox" id="chkMiltON" class="OOMchk" style="margin-left: 40px"><label for="chkMiltON"><img src=${MiltONIcon} height="18" width="18">Milton, ON</label></div>`,
            //             `<div><input type="checkbox" id="chkTorON" class="OOMchk" style="margin-left: 40px"><label for="chkTorON"><img src=${TorONIcon} height="18" width="18">Toronto, ON</label></div>`,
...
//                 window.open(`http://maps.milton.ca/MGIS//UrlHandler.ashx?MINX=${geoNW.x}&MINY=${geoNW.y}&MAXX=${geoSE.x}&${geoSE.y}&SCALE=${scale}&LABEL=%7c-8893397.4%7c5389213.86%7c103972%7c0%2c0%2c0%7c10%7cTRIANGLE%7c128%2c0%2c64%7c8%7c%7c&LAYERS_TO_SHOW=336737867,488968977,257339439,257339517,336737802`, 'MiltON');
//             });
//         }
        $('#OOMBramON').remove();
        if(settings.BramON)
