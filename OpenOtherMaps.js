    ...
    function LoadMapButtons(){
        ...
        if(settings.MiltON)
        {
            ...
            $('#OOMMiltONImg').click(function(){
                window.open(`http://maps.milton.ca/MGIS//UrlHandler.ashx?MINX=${geoNW.x}&MINY=${geoNW.y}&MAXX=${geoSE.x}&${geoSE.y}&SCALE=${mapScale}&LABEL=%7c-8893397.4%7c5389213.86%7c103972%7c0%2c0%2c0%7c10%7cTRIANGLE%7c128%2c0%2c64%7c8%7c%7c&LAYERS_TO_SHOW=336737867,488968977,257339439,257339517,336737802`, 'MiltON');
            });
        }
        $('#OOMBramON').remove();
        if(settings.BramON)
